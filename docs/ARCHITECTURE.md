...
│   ├── llm/                 # Provider router (Claude vs ChatGPT)
...
- **llm/** - Provider router selecting Claude or ChatGPT at runtime
- **claude/** - Claude API integration for Telegram chat + summaries
- **chatgpt/** - ChatGPT integration for Telegram chat + summaries
